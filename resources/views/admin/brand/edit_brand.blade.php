                ...
                <div class="col-12 col-lg-7 col-xl-8">
                  @include('admin.alert')
                    <div class="box-profile">
                                ...
                                <div class="box p-15">		
                                    <form method="post" action="{{ route('brand.update',$editdata->id) }}" class="form-horizontal form-element col-12" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          ...
                                          <img id="previewImg" src="{{ !empty($editdata->brand_image)? url('upload/brand_images/'.$editdata->brand_image):url('upload/no_image.jpg') }}" 
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <input name="brand_name" type="text" class="form-control" id="brand_name" value="{{ $editdata->brand_name  }}" required>
                                          @error('brand_name')   
