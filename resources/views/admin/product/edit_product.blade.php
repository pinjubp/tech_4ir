                ...
                <div class="col-12 col-lg-7 col-xl-8">
                  @include('admin.alert')
                    <div class="box-profile">
                                ...
                                <div class="box p-15">		
                                    <form method="post" action="{{ route('product.update',$product->id) }}" class="form-horizontal form-element col-12" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="row">
                                        <div class="col-lg-3">
                                          <div class="form-group mg-b-10-force">
                                            ...
                                            <select class="form-control select2" data-placeholder="Choose Category" name="user_id" tabindex="-1" aria-hidden="true">
                                              <option label="Choose Category"></option>
                                              @foreach ($user as $value )
                                                <option value="{{ $value->id }}"  {{ $value->id == $product->user_id ? 'selected':'' }}>                                                   
                                                    {{ $value->name  }}
                                                </option>
                                              @endforeach
                                            </select>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <textarea id="editor1"   name="product_details"  placeholder="Place some text here" required>{{ $product->product_details }}</textarea>
                                      ...
                                      <div class="form-group row mt-3">
                                        <div class="ml-auto col-sm-12">
                                          ...
                                          <a href="" class="btn btn-rounded btn-success"  >Add specifications</a>
                                        </div>
                                      </div>
                                    </form>
                                </div>
