                ...
                <div class="col-12 col-lg-7 col-xl-8">
                  @include('admin.alert')
                    <div class="box-profile">
                                ...
                                <div class="box p-15">		
                                    <form method="post" action="{{ route('store.service') }}" class="form-horizontal form-element col-12" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <input name="service_icon" type="text" class="form-control" id="service_icon" placeholder="Select icon" data-fa-browser >
                                          @error('service_icon')   
                                                <span class="text-danger">{{ $message }}</span>    
                                           @enderror
                                        </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea  name="service_details" id="editor1" rows="10" cols="80"  placeholder="Place some text here" required></textarea>
