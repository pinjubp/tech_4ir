                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Create Contact Address</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-7 col-xl-8">
                  @include('admin.alert')
                    <div class="box-profile">
                                ...
                                <div class="box p-15">		
                                    <form method="post" action="{{ route('store.contact.address') }}" class="form-horizontal form-element col-12" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea  name="addressdetails" id="editor1" rows="10" cols="80"  placeholder="Place some text here" required></textarea>
